...
module.exports = {
  ...
  rules: {
    ...
    "at-rule-allowed-list": ["use", "for", "if", "else", "include", "extend", "return", "error", "each", "mixin", "media", "function", "keyframes", "font-face", "forward", "at-root", "while"],
